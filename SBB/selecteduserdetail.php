...
?>
	...
	<div class="container">
        <h2 class="text-center pt-4" style="color : black; background-color:#00BFFF;">Transaction</h2>
            <?php
                include 'config.php';
                $sid=$_GET['id'];
        ...
        <div>
            <table class="table table-striped table-condensed table-bordered table-light">
